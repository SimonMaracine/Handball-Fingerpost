...
class PlayerPanel:
    ...
    def __init__(self, x: int, y: int, player, teams: tuple):
        ...
        self.player = player
        self.teams = teams
        self.team_score_button = Button(x + 20, y + 15 + 20, "+ Team score", 13, (17, 16, 255, 255),
                                        bold=True, secondary_color=(160, 160, 160, 255))
        self.team_score_button2 = Button(x + 20, y + 15, "- Team score", 13, (16, 16, 255, 255),
                                         bold=True, secondary_color=(160, 160, 160, 255))
        self.suspend_button = Button(x + 20, y + 15 - 20, "Suspend", 13, (200, 16, 16, 255),
                                     bold=True, secondary_color=(160, 160, 160, 255))
        self.release_button = Button(x + 20, y + 15 - 40, "Release", 13, (16, 235, 16, 255),
                                     bold=True, secondary_color=(160, 160, 160, 255))
        self.yellow_card_button = Button(x + 20, y + 15 - 60, "+ Yellow card", 13, (255, 255, 17, 255),
                                         bold=True, secondary_color=(160, 160, 160, 255))
        self.yellow_button2 = Button(x + 20, y + 15 - 80, "- Yellow card", 13, (255, 255, 16, 255),
                                     bold=True, secondary_color=(160, 160, 160, 255))
        self.red_card_button = Button(x + 20, y + 15 - 100, "+ Red card", 13, (255, 16, 17, 255),
                                      bold=True, secondary_color=(160, 160, 160, 255))
        self.red_button2 = Button(x + 20, y + 15 - 120, "- Red card", 13, (255, 16, 16, 255),
                                  bold=True, secondary_color=(160, 160, 160, 255))
        self.disqualify_button = Button(x + 20, y + 15 - 140, "Disqualify", 13, (120, 64, 64, 255),
                                        bold=True, secondary_color=(160, 160, 160, 255))
        self.buttons = (
        ...
        self.width = 145
        self.height = 22 * len(self.buttons)
